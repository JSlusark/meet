...
//read only packages defined as a scope below
const SCOPES = ["https://www.googleapis.com/auth/calendar.readonly"];

// stored credentials are values used by google to generate authetication URL to access calendat api, credentials are then destructured.
//process.env” allows these values to be grabbed from the “config.json” file so that APIS are hidden by adding it to gitinore
const credentials = {
	...
	redirect_uris: ["https://birdieber.github.io/meet/"],
	javascript_origins: ["https://birdieber.github.io", "http://localhost:3000"],
};
const { client_secret, client_id, redirect_uris, calendar_id } = credentials;

// From the Google API, using the new operator, a new instance of the google.auth.OAuth2 method was called and created.
